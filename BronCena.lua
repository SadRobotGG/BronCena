...
local function ActionDefaults(...)
    ...
    return {
        disabled = false,
        name = name or nil, -- Descriptive name
        zones = {
            party = nil,
            raid = nil,
            pvp = nil,
...
local defaults = {
    profile = {
        ...
        -- Default companions
        companions = {
            ["333961"] = CompanionDefaults("333961", "Bron Cena", "", ActionDefaults("Bron's Theme", soundOptions.shoryuken, "And his name is BRON CENA!")),
